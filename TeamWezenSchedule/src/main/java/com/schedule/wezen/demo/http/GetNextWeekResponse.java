...
public class GetNextWeekResponse {
	...
	public GetNextWeekResponse (String sdow, String st, String id, int sd, int sc, int nsd, String ssd, String sed, ArrayList<TimeSlot> wts, String response, int code) {
	...
	public GetNextWeekResponse (String sdow, String st, String id, int sd, int sc, int nsd, String ssd, String sed, ArrayList<TimeSlot> wts, String response) {
		this.responseStartDateOfWeek = sdow;
		this.responseStartTime = st;
		this.responseID = id;
		this.responseSlotDuration = sd;
	...
	public GetNextWeekResponse (String response, int code) {
	...
	public String toString() {
		return "GetNextWeekResponse(" + response + ")";
	}
