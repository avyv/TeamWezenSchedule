...
public class BulkEditResponse {
	...
	public BulkEditResponse (String sdow, String st, String id, int sd, int sc, int nsd, String ssd, String sed, ArrayList<TimeSlot> wts, String response, int code) {
	...
	public BulkEditResponse (String sdow, String st, String id, int sd, int sc, int nsd, String ssd, String sed, ArrayList<TimeSlot> wts, String response) {
		this.responseStartDateOfWeek = sdow;
		this.responseStartTime = st;
		this.responseID = id;
		this.responseSlotDuration = sd;
	...
	public BulkEditResponse (String response, int code) {
	...
	public String toString() {
		return "BulkEditResponse(" + response + ")";
	}
